...
df =  pd.read_csv('C:/Users/Caleb/OneDrive/Desktop/OneDrive/Projects/NBA Draft Outcome Predictor/NBAStats.csv')[0:524]
...
df.to_csv('CollegeStats.csv', index=False, encoding='utf-8')