...
df =  pd.read_csv('/Users/calebmiller/Library/CloudStorage/OneDrive-Personal/Projects/NBA Draft Outcome Predictor/NBAStats.csv')[0:524]
...
df.to_csv('CollegeStats2.csv', index=False, encoding='utf-8')