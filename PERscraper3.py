...
df =  pd.read_csv('C:/Users/Caleb/OneDrive/Desktop/OneDrive/Projects/NBA Draft Outcome Predictor/NBAStats.csv')[1049:1574]
...
df.to_csv('PER3.csv', index=False, encoding='utf-8')