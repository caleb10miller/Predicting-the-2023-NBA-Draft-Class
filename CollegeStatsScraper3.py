...
df =  pd.read_csv('/Users/calebmiller/Library/CloudStorage/OneDrive-Personal/Projects/NBA Draft Outcome Predictor/NBAStats.csv')[1049:1574]
...
df.to_csv('CollegeStats3.csv', index=False, encoding='utf-8')