...
df =  pd.read_csv('C:/Users/Caleb/OneDrive/Desktop/OneDrive/Projects/NBA Draft Outcome Predictor/NBAStats.csv')[524:1049]
...
df.to_csv('PER2.csv', index=False, encoding='utf-8')